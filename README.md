...
| breakPoint        | `number/function` | The breakpoint in pixels at which accordion mode is activated. Functions must return a boolean             | `991`           |
...
| pushState         | `boolean`         | Whether to push tab changes to window.history() falling back to location.hash                              | `false`         |
